...
function ItemCount ({ini, min, max}) {
    ...
    <div style={{paddingBottom: 10}}>
        <button disabled={count === min} type='button' class='btn' style={{border:'none'}} onClick={() => setCount(count - 1)}>
        ...
        <span>{count}</span>
        <button disabled={count === max} type='button' class='btn' onClick={() => setCount(count + 1)}>
